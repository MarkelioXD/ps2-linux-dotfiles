...
s0_rotate_left_window_key = <Shift><Super>Prior
s0_rotate_left_window_button = Disabled
s0_rotate_right_window_key = <Shift><Super>Next
...
s0_prev_key = Disabled
s0_prev_button = Disabled
s0_left_window_key = <Shift><Super>Prior
s0_right_window_key = <Shift><Super>Next
...
s0_skydome = true
s0_skydome_image = /home/mark/Descargas/8hndyng4homb1.png
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;copytex;imgjpeg;maximumize;decor;gnomecompat;grid;imgpng;mousepoll;move;place;regex;resize;shift;showdesktop;winrules;wobbly;animation;commands;cube;expo;ezoom;obs;rotate;switcher;
